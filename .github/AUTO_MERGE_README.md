...
- `wip-auto-merge.yml` - WIP（作業中）プルリクエストの自動マージワークフロー（新規）
...
### WIP（作業中）プルリクエストの自動マージ

1. プルリクエストを作成し、WIPラベルを追加：
   - `wip`
   - `work-in-progress`
   - `draft`
2. 作業完了後、自動マージラベルを追加：
...
3. 必要なレビューを取得
4. すべてのチェックが成功するのを待つ
5. WIPラベルが自動的に削除され、プルリクエストが自動マージされる
...
### 4. wip-auto-merge.yml（新規）
- WIP（作業中）プルリクエストの自動マージ機能
- WIPラベルの自動削除
- 作業完了時の自動マージ
- 段階的なマージプロセス

### 5. pr-auto-merge-settings.yml
- 設定管理用
- 手動での設定変更
- 設定の確認と更新
